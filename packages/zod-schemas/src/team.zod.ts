import { zSmallint, zString } from "@zod-schemas/zod_utils";
import z from "zod";
...
export const teamUpdateInputZod = teamMandatoryZod.extend(teamOptionalZod.shape).extend(teamAutoGeneratedZod.partial());
export type TeamUpdateInput = z.infer<typeof teamUpdateInputZod>;

export const teamSelectAllZod = teamMandatoryZod.extend(teamOptionalZod.shape).extend(teamAutoGeneratedZod.shape);
